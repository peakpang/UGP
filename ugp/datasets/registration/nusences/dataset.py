...
from ugp.utils.common import load_pickle
from ugp.utils.pointcloud import (
    random_sample_rotation,
    get_transform_from_rotation_translation,
    get_rotation_translation_from_transform,
)
from ugp.utils.registration import get_correspondences


class OdometryNusencePairDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        super(OdometryNusencePairDataset, self).__init__()
        ...
        self.metadata = load_pickle(osp.join(self.dataset_root, f'metadata_{distance}', f'{subset}.pkl'))
    ...
    def __getitem__(self, index):
        ...
        data_dict['seq_id'] = metadata['dirname']
