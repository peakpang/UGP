...
from ugp.modules.layers import build_dropout_layer
from ugp.modules.transformer.output_layer import AttentionOutput
...
class RPEMultiHeadAttention(nn.Module):
    ...
    def forward(self, input_q, input_k, input_v, embed_qk, key_weights=None, key_masks=None, attention_factors=None, attention_masks=None):
