...
from ugp.utils.common import ensure_dir
...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.root_dir, 'data', 'nuScenes')
...
_C.max_points = 780 # if GPU memory > 24G, set max_points to None
...
_C.backbone.decoder_input_dim = 256
