...
from ugp.engine import SingleTester
from ugp.utils.common import ensure_dir, get_log_string
from ugp.utils.torch import release_cuda
...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        data_loader, neighbor_limits = test_data_loader(cfg, self.args.distance)
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        np.savez_compressed(
            ...
            rre=release_cuda(result_dict['RRE']),
            rte=release_cuda(result_dict['RTE']),
        )
